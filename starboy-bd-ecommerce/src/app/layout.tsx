...
export const metadata: Metadata = {
  ...
  description: "Elevate your style with STARBOY BD. Premium ready-to-wear collections, urban streetwear, premium shirts, and leather goods in Bangladesh.",
          ...
          <CartProvider>
            <WishlistProvider>
              ...
              <Toaster position="top-center" toastOptions={{
                style: { background: "#1A1505", color: "#F7F3EC", border: "1px solid rgba(184,134,11,0.3)" },
                success: { iconTheme: { primary: "#B8860B", secondary: "#1A1505" } },
              }} />
            </WishlistProvider>
          </CartProvider>
        </AuthProvider>
